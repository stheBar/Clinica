    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="header-row">
                <span></span>
                <a href="<c:url value='/admin/paciente'/>?action=new" class="btn btn-success">+ Novo Paciente</a>
            </div>
            ...
            <table class="table">
                ...
                <c:forEach var="p" items="${pacientes}">
                    <tr>
                        ...
                        <td>${p.historico}</td>
                        <td class="actions">
                            <a href="<c:url value='/admin/paciente'/>?action=edit&id=${p.id}" class="btn btn-warning">Editar</a>
                            <form method="post" action="<c:url value='/admin/paciente'/>">
