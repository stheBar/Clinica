    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="header-row">
                <span></span>
                <a href="<c:url value='/admin/consulta'/>?action=new" class="btn btn-success">+ Nova Consulta</a>
            </div>
            ...
            <table class="table">
                ...
                <c:forEach var="c" items="${consultas}">
                    <tr>
                        ...
                        <td>${c.status}</td>
                        <td class="actions">
                            <a href="<c:url value='/admin/consulta'/>?action=edit&id=${c.id}" class="btn btn-warning">Editar</a>
                            <form method="post" action="<c:url value='/admin/consulta'/>" >
